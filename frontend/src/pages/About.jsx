      ...
      <div className="max-w-4xl mx-auto bg-white rounded-xl p-8 md:p-12 border border-gray-100">
        <section className="mb-10">
          ...
          <p className="text-gray-600 text-base leading-relaxed">
            Founded in 2026, LABAS is a modern fashion brand offering a
          ...
          <p className="text-gray-600 text-base leading-relaxed mt-4">
            ...
            maintaining timeless appeal. At LABAS, fashion is not just about
        ...
        <section>
          ...
          <ul className="grid sm:grid-cols-2 gap-y-2 text-base text-gray-600 list-none">
            <li>Quality</li>
            <li>Innovation</li>
