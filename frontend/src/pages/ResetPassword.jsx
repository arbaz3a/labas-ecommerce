    ...
    return (
        <div className="min-h-screen flex items-center justify-center px-6 bg-[#F7F7F8] relative">
            ...
            <div className="w-full max-w-[420px]">
                ...
                {!success ? (
                    <>
                        <h1 className="text-[24px] font-bold text-center mb-2 text-black" style={{ fontFamily: "'Georgia', serif" }}>
                            Set New Password
                        </h1>
                        ...
                        <div className="auth-card">
                            <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                                <div>
                                    <label className="block text-[12px] font-medium tracking-[0.15em] uppercase mb-2 text-gray-400">New Password</label>
                                ...
                                <div>
                                    <label className="block text-[12px] font-medium tracking-[0.15em] uppercase mb-2 text-gray-400">Confirm Password</label>
                                    <input
                                        type="password"
                    ...
                    <>
                        ...
                        <div className="auth-card text-center">
                            <Link to="/signin" className="btn-primary inline-block w-full text-center">
                                Sign In
                            </Link>
                        </div>
                    </>
